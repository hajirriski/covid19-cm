      ...
      <ul>
        ...
        <li class="mt-10">
          ...
          <div class="content">
            ...
            <a href="<?= base_url() ?>admin/cekdikirimkelab" class="konten active"><strong>Dikirim ke lab</strong></a>
...
where StatusLaporan='Sent to Lab'
    ");                  $count = 1;
