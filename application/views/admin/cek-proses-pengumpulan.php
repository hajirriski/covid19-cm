  ...
  <body>
      ...
      <ul>
        ...
        <li class="mt-10">
          ...
          <div class="content">
            ...
            <a href="<?= base_url() ?>admin/cekprosespengumpulan" class="konten active"><strong>Dalam proses untuk pengumpulan sampel</strong></a>
    ...
    <div class="container">
      ...
      <header style="padding: 30px 20px 60px 20px" class="bg-primary">
        <h1>Dalam proses untuk pengumpulan sampel</h1>
      </header>
      <div class="card" style="margin-top: -25px; z-index: 99">
        <div class="card-header">
          <h2>Dalam proses untuk pengumpulan sampel</h2>
        </div>
        <div class="card-body">
...
where StatusLaporan='On the Way for Collection'
    ");                  $count = 1;
