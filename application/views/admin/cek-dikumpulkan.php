      ...
      <ul>
        ...
        <li class="mt-10">
          ...
          <div class="content">
            ...
            <a href="<?= base_url() ?>admin/cekdikumpulkan" class="konten active"><strong>Sampel dikumpulkan</strong></a>
...
where StatusLaporan='Sample Collected'
    ");                  $count = 1;
